...
enyo.kind({
	...
	download: function(force) { this._uniqueAttachment.download(force); },
	cancel: function() { this._uniqueAttachment.cancel(); },
	getProgress: function() { return this._uniqueAttachment.progress; },
	getPath: function() { return this._uniqueAttachment.path; }
