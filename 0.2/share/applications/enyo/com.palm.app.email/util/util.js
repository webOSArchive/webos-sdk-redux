...
EmailApp.Util.setUpConnectionWatch = function () {
	...
	var reqHandler = enyo.bind(null, EmailApp.Util.callbackRouter, 
							function (resp) {console.log("connection status updated: " + JSON.stringify(resp)); app.connectionStatus = resp;}, /// onSuccess
							function (resp) {console.log("connectionmanager 'getStatus' request failed." + JSON.stringify(resp));}); // onFailure
