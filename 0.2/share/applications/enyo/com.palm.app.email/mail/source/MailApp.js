...
enyo.kind({
	...
	components: [
		...
		{name: "appMenu", kind: "AppMenu", components: [
			...
			{name: "openNewCard", caption: $L("Open Email in New Card")}, /* for testing */
	...
	handleDisplayMessage: function (msgId, folder) {
		...
		if (enyo.application.dbServiceHook) { enyo.application.dbServiceHook(this.$.messageDisplayFetcher); }
