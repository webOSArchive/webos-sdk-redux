		...
		{kind: "Scroller", flex: 1, components: [
			{kind:"Control", className:"box-center", components:[
				...
				]},
				{
					...
					components : [{name : "email", kind : "Input", inputType: "email", value : "", onkeypress: "isFormComplete", onkeydown: "checkEnter", onkeydown: "checkEnter",  spellcheck: false, autocorrect:false, className: "babelfish", onblur: "isFormComplete", autoCapitalize: "lowercase"}]
				},
				{
					kind : "RowGroup",
					className:"accounts-group",
