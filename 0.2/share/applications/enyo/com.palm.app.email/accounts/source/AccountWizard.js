...
AccountWizard.prototype.accountValidateManual = function(params, onSuccess, onFailure){
	...
	var  parsePort = function(port) { return (port) ? parseInt(port, 10) : 0;};
...
AccountWizard.prototype._retrieveCredentials = function(accountId, inSettings, outSettings, rootFolder) {
	...
	if (!outboundGrabbed) {
		this.outReq = EmailAccount.getCredentials(accountId, "smtp", function(credentials) { hookupCredentials('out', credentials); });
	} 
	
	if (!inboundGrabbed) {
		this.inReq = EmailAccount.getCredentials(accountId, "common", function(credentials) { hookupCredentials('in', credentials); });
	} 
};
...
AccountWizard.prototype._getTemplateList = function() {
	...
	return EmailApp.Util.callService('palm://com.palm.service.accounts/listAccountTemplates', {
			...
			function(resp) { that.templateList = resp.results || resp; that._parseTemplates();}
		);			
};
...
AccountWizard.prototype._parseTemplates = function() {
	...
	this.templateList.forEach(function(elem){
		...
		if (!elem.capabilityProviders || elem.capabilityProviders.filter(function(elem) { return elem.capability === "MAIL";}).length < 1) {
			return;
		}
...
AccountWizard.ServerConfig = [// Prefix, type, port, SSL
...
AccountWizard.PredefinedEasAccounts = {
	...
	"actualhelp.com": {
		"server": "https://etlwex01.actualhelp.com",
		"protocol": AccountWizard.EAS,
		"domain": "actualhelp",
		"port": 443,
		"ssl": ProtocolSettings.SSL,
	...
	"qaetl.com": {
		"server": "https://etlwdc02.qaetl.com",
		"protocol": AccountWizard.EAS,
		"domain": "qaetl",
		"port": 443,
		"ssl": ProtocolSettings.SSL,
	...
	"testerslife.com": {
		"server": "https://etlwex03.testerslife.com",
		"protocol": AccountWizard.EAS,
		"domain": "testerslife",
		"port": 443,
		"ssl": ProtocolSettings.SSL,
	...
	"vmtest.net": {
		"server": "https://webaccess.vmtest.net/servlet/traveler",
		"protocol": AccountWizard.EAS,
		"domain": "",
		"port": 443,
		"ssl": ProtocolSettings.SSL,
