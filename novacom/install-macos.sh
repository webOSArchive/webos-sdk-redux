#!/bin/bash
#
# Installation script for modernized novacom
...
echo ""
echo "=========================================="
echo "  novacom Installation for Modern macOS"
echo "=========================================="
echo ""
...
# Use install command for more robust copying on macOS
...
chown root:wheel "$INSTALL_DIR/novacom"
...
chown root:wheel "$INSTALL_DIR/novaterm"
